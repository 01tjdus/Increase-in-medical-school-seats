...
|--------|------|------|------------------------|
| `의대증원_카페_v2.json` | 카페 크롤 원본(게시글·댓글 등 누적 JSON) | [`notebooks/00_crolling/cafe_crolling.py`](../../notebooks/00_crolling/cafe_crolling.py) | [`notebooks/01_cafe/cafedata_preprocess.ipynb`](../../notebooks/01_cafe/cafedata_preprocess.ipynb) |
