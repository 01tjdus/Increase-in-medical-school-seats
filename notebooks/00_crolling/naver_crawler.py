...
# 기본값: 저장소 루트의 data/blog_only/ (실행 cwd와 무관). --output 으로 덮어쓸 수 있습니다.
...
_BLOG_DIR = _repo_root() / "data" / "blog_only"
_BLOG_DIR.mkdir(parents=True, exist_ok=True)
OUTPUT_FILE = str(_BLOG_DIR / "naver_blog_medical_quota.csv")
...
LINKS_OUTPUT_FILE = str(_BLOG_DIR / "naver_blog_medical_quota_links.csv")
