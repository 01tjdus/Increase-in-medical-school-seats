...
STOPWORDS_DIR = ROOT / "stopwords"

OUTPUTS_DIR = ROOT / "outputs"
OUTPUTS_ANALYSIS = OUTPUTS_DIR / "analysis"
OUTPUTS_ANALYSIS_DATASETS = OUTPUTS_ANALYSIS / "datasets"
OUTPUTS_ANALYSIS_KMEANS = OUTPUTS_ANALYSIS / "kmeans"
OUTPUTS_ANALYSIS_LDA = OUTPUTS_ANALYSIS / "lda"
OUTPUTS_ANALYSIS_STOPWORDS = OUTPUTS_ANALYSIS / "stopwords"
OUTPUTS_ANALYSIS_TFIDF = OUTPUTS_ANALYSIS / "tfidf"
OUTPUTS_ANALYSIS_WORDCLOUD = OUTPUTS_ANALYSIS / "wordcloud"
OUTPUTS_ANALYSIS_WORDCLOUD_FILTERED = OUTPUTS_ANALYSIS_WORDCLOUD / "filtered"
OUTPUTS_ANALYSIS_WORDCLOUD_RAW = OUTPUTS_ANALYSIS_WORDCLOUD / "raw"
...
def ensure_output_dirs() -> tuple[Path, ...]:
    ...
    output_dirs = (
        OUTPUTS_ANALYSIS,
        OUTPUTS_ANALYSIS_DATASETS,
        OUTPUTS_ANALYSIS_KMEANS,
        OUTPUTS_ANALYSIS_LDA,
        OUTPUTS_ANALYSIS_STOPWORDS,
        OUTPUTS_ANALYSIS_TFIDF,
        OUTPUTS_ANALYSIS_WORDCLOUD,
        OUTPUTS_ANALYSIS_WORDCLOUD_FILTERED,
        OUTPUTS_ANALYSIS_WORDCLOUD_RAW,
    )
